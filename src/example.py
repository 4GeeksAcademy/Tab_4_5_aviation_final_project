...
image = Image.open("/workspaces/Tab_4_5_aviation_final_project/src/static/photo.jpg")  # Adjust path if necessary
# ---------------------------
# LOAD AIRPORT DATA
# ---------------------------
@st.cache_data
...
def main():
    ...
    # Incident Predictor tab (get selected airports)
    with tab1:
        origin_label, dest_label = tab_one_func.tab1(airports, model=None, frequencies=None)
    with tab2:
